...
declare type Presentation = {
    ...
    leafButtonSmallEdit: (args: { link: string }) => { root: HTMLElement };
    leafButtonSmallView: (args: { link: string }) => { root: HTMLElement };
    ...
    contMenuBody: (args: { children: HTMLElement[], user: string }) => { root: HTMLElement };
