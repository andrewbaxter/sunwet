...
declare type Presentation = {
    ...
    contPageNode: (args: { barChildren: Element[], children: Element[] }) => { root: Element, body: Element };
    ...
    leafNodeEditButtons: (args: { link?: string }) => { root: Element, buttonDelete: Element, buttonRevert: Element };
