...
declare type Presentation = {
    ...
    leafButtonBig: (args: { title: string, icon?: string, text?: string, extraStyles: string[] }) => { root: Element };
    leafButtonBigView: (args: {  }) => { root: Element };
    ...
    leafLogsLine: (args: { stamp: string, text: string }) => { root: Element };
    contPageLogs: (args: { children: Element[] }) => { root: Element };
    ...
    contMediaFullscreen: (args: { media: Element }) => { root: Element, buttonClose: Element, buttonFullscreen: Element, seekbar: Element, seekbarFill: Element, seekbarLabel: Element };
    contModalViewShare: (args: { qr: Element, link: string }) => { root: Element, buttonClose: Element, buttonUnshare: Element };
    ...
    leafViewIcon: (args: { icon: string, link?: string, width?: string, height?: string, color?: string, transAlign: TransAlign, orientation: Orientation }) => { root: Element };
    ...
    leafViewDatetime: (args: { transAlign: TransAlign, orientation: Orientation, value: string, fontSize?: string, color?: string }) => { root: Element };
    leafViewDate: (args: { transAlign: TransAlign, orientation: Orientation, value: string, fontSize?: string, color?: string }) => { root: Element };
    leafViewTime: (args: { transAlign: TransAlign, orientation: Orientation, value: string, fontSize?: string, color?: string }) => { root: Element };
    ...
    contPageNodeView: (args: { children: Element[] }) => { root: Element, body: Element };
    contPageNodeEdit: (args: { barChildren: Element[], children: Element[] }) => { root: Element, body: Element };
    ...
    leafNodeViewNodeButtons: (args: { download?: string, history?: string, edit?: string, link?: string }) => { root: Element };
    ...
    leafNodeEditToolbar: (args: { link?: string, count?: number, total?: number }) => { root: Element, buttonDelete: Element, buttonRevert: Element };
    ...
    leafNodeEditNumberTextCenter: (args: { total: number }) => { root: Element };
    contPageHistory: (args: { barChildren: Element[], children: Element[] }) => { root: Element, body: Element };
    ...
    contPageQuery: (args: { initialQuery: string }) => { root: Element, query: Element, prettyResults: Element, jsonResults: Element, downloadField: Element, downloadPattern: Element, downloadResults: Element, edit: Element, commitButton: Element };
    contQueryPrettyRow: (args: { children: Element[] }) => { root: Element };
    leafQueryPrettyInlineKV: (args: { key: string, value: string, link: string }) => { root: Element };
    leafQueryPrettyMediaKV: (args: { key: string, value: Element, link: string }) => { root: Element };
    leafQueryJsonRow: (args: { data: string }) => { root: Element };
    leafQueryDownloadRow: (args: { link: string, filename: string }) => { root: Element };
    ...
    contBarMain: (args: { leftChildren: Element[], leftMidChildren: Element[], midChildren: Element[], rightMidChildren: Element[], rightChildren: Element[] }) => { root: Element };
