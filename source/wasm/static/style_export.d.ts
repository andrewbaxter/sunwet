...
declare type Presentation = {
    ...
    leafInputImage: (args: { id?: string, title: string }) => { root: Element, input: Element };
    leafInputVideo: (args: { id?: string, title: string }) => { root: Element, input: Element };
    leafInputAudio: (args: { id?: string, title: string }) => { root: Element, input: Element };
    ...
    leafInputPairImage: (args: { id: string, title: string }) => { root: Element, input: Element };
    leafInputPairVideo: (args: { id: string, title: string }) => { root: Element, input: Element };
    leafInputPairAudio: (args: { id: string, title: string }) => { root: Element, input: Element };
