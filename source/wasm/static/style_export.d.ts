...
declare type Presentation = {
    playlistStateChanged: (args: { playing: boolean, index: number }) => void;
    ...
    leafButton: (args: { title: string, text: string, extraStyles: string[] }) => { root: HTMLElement };
    leafBarButtonBig: (args: { title: string, text: string }) => { root: HTMLElement };
