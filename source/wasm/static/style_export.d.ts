...
declare type Presentation = {
    ...
    leafAsyncBlock: (args: { inRoot: boolean, extraStyles: string[] }) => { root: Element };
    ...
    leafInputPairNumber: (args: { id: string, title: string, value: string }) => { root: Element, input: HTMLInputElement };
    leafInputPairBool: (args: { id: string, title: string, value: boolean }) => { root: Element, input: HTMLInputElement };
    leafInputPairDate: (args: { id: string, title: string, value: string }) => { root: Element, input: HTMLInputElement };
    leafInputPairTime: (args: { id: string, title: string, value: string }) => { root: Element, input: HTMLInputElement };
    leafInputPairDatetime: (args: { id: string, title: string, value: string }) => { root: Element, input: HTMLInputElement };
    leafInputPairColor: (args: { id: string, title: string, value: string }) => { root: Element, input: HTMLInputElement };
    leafInputPairEnum: (args: { id: string, title: string, value: string, options: {[k: string]: string} }) => { root: Element, input: HTMLSelectElement };
    ...
    leafViewPlayButton: (args: { transAlign: TransAlign, direction: Direction }) => { root: Element };
    ...
    contPageNodeView: (args: { pageButtonChildren: Element[], children: Element[] }) => { root: Element };
    ...
    appLinkPerms: (args: {  }) => { root: Element };
