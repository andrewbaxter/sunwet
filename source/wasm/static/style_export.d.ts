...
declare type Presentation = {
    ...
    contPageView: (args: { transport?: HTMLElement, params: HTMLElement[], elements: HTMLElement }) => { root: HTMLElement };
    ...
    contViewRoot: (args: { elements: HTMLElement[], elementWidth?: string }) => { root: HTMLElement };
    contViewElement: (args: { body: HTMLElement, height?: string, expand?: HTMLElement }) => { root: HTMLElement };
    ...
    leafViewPlayButton: (args: { transAlign: TransAlign, orientation: Orientation }) => { root: HTMLElement };
    leafViewNodeButton: (args: { transAlign: TransAlign, orientation: Orientation }) => { root: HTMLElement };
    ...
    contPageNodeView: (args: { children: HTMLElement[] }) => { root: HTMLElement };
    ...
    leafNodeViewToolbarEditListLinkButton: (args: { link: string }) => { root: HTMLElement };
    leafNodeViewToolbarNodeButton: (args: {  }) => { root: HTMLElement };
    contPageNodeEdit: (args: { barChildren: HTMLElement[], children: HTMLElement[] }) => { root: HTMLElement };
    ...
    contPageListEdit: (args: { backToViewLink: string, children: HTMLElement[] }) => { root: HTMLElement, numberedToggle: HTMLElement, numberedOuter: HTMLElement, buttonMoveUp: HTMLElement, buttonMoveDown: HTMLElement, buttonDeselect: HTMLElement, buttonDelete: HTMLElement, buttonCommit: HTMLElement };
    leafPageListEditEntry: (args: { id: string, idLink: string, name: string }) => { root: HTMLElement, deleteButton: HTMLElement, number: HTMLElement, checkbox: HTMLElement };
    contModalNode: (args: { currentListName?: string, currentListId?: string, currentListLink?: string, nodeLink: string }) => { root: HTMLElement, errors: HTMLElement, buttonClose: HTMLElement, buttonSetList: HTMLElement, buttonAddToList: HTMLElement };
