...
import type { FormFieldAutocomplete } from "./FormFieldAutocomplete";
...
export type FormFieldType = "id" | { "comment": FormFieldComment } | { "text": FormFieldText } | { "autocomplete": FormFieldAutocomplete } | { "number": FormFieldNumber } | { "bool": FormFieldBool } | "date" | "time" | "datetime" | "datetime_now" | { "rgb_u8": FormFieldRgbU8 } | { "const_enum": FormFieldConstEnum } | { "query_enum": FormFieldQueryEnum } | "file";
